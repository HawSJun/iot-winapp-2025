...
using System.DirectoryServices.ActiveDirectory;    // 백그라운드 워커 이벤트 아규먼트 네임스페이스
...
namespace SyntaxWinApp01
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            BgwProcess.ProgressChanged += BgwProcess_ProgressChanged; // 백그라운드 진행 상태 변경 이벤트
            BgwProcess.RunWorkerCompleted += BgwProcess_RunWorkerCompleted; // 백그라운드 진행 완료 이벤트
        ...
        private void BgwProcess_ProgressChanged(object? sender, ProgressChangedEventArgs e)
        {
            ...
            int currVal = (int)e.UserState; // ReportProgress(1, 2) 중 2번으로 넘어온 값
