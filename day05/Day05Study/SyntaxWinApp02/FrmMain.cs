namespace SyntaxWinApp02
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            var resList3 = numbers.Where(n => n % 2 == 0)
                                   .OrderBy(n => n);
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            TxtTest.KeyPress += TxtTest_KeyPress;   // Desiner에서 작업하는 것과 동일
            TxtTest.Font = new Font("휴먼매직체", 8, FontStyle.Italic);
        }

        public void TxtTest_KeyPress(object? sender, KeyPressEventArgs e)
        {
